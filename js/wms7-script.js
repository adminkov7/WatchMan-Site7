...
window.onload = function() {
	...
	var action = wms7_getUrlVars()['action'];
	...
	if (page == 'wms7_visitors') {
		...
		if (action == 'delete') {
			if (wms7_getUrlVars()['result0']) {
				result = '&result=0';
			} else if (wms7_getUrlVars()['result1']) {
				result = '&result=1';
			} else if (wms7_getUrlVars()['result2']) {
				result = '&result=2';
			} else if (wms7_getUrlVars()['result3']) {
				result = '&result=3';
			} else if (wms7_getUrlVars()['result4']) {
				result = '&result=4';
			} else if (wms7_getUrlVars()['result5']) {
				result = '&result=5';
			} else {
				result = '';
			}
			if (get_cookie( 'wms7_doaction1' )) {
				arr            = get_cookie( 'wms7_doaction1' ).split( ',' );
			...
			if (get_cookie( 'wms7_doaction3' )) {
				filter_login_ip = (get_cookie( 'wms7_doaction3' ) != '') ? get_cookie( 'wms7_doaction3' ) : '';
			...
			url = url + '?' + page + paged + result + filter_role + filter_time + filter_country + filter_login_ip + orderby + order;
